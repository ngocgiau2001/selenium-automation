...
public class MajorsPage {
    private WebDriverWait wait;

    // Xác định ô nhập liệu tìm kiếm
    @FindBy(css = "input[placeholder='Search majors...']")
    ...
    public MajorsPage(WebDriver driver) {
        this.wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        PageFactory.initElements(driver, this);
    }

    // Hàm tìm kiếm chuyên ngành
    public void searchMajor(String keyword) {
        ...
        WebElement searchInput = wait.until(ExpectedConditions.visibilityOfElementLocated(
                org.openqa.selenium.By.cssSelector("input[placeholder='Search majors...']")));
        ...
        try {
            ...
            if (tableRows.size() == 1) {
                ...
                if ((rowClass != null && (rowClass.contains("empty") || rowClass.contains("no-data")))
                        ...
                        || rowText.contains("no majors yet")
